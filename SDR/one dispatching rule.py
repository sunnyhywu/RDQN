...
#所有機器的Dispatching rule
#(0.FIFO; 1.SPT; 2.LPT; 3.MOPNR; 4.MWKR; 5.SNQ; 6.LNQ)
rule=3
...
num_disptching_rule = 7     # 共有幾個派遣規則(0.FIFO; 1.SPT; 2.LPT; 3.MOPNR; 4.MWKR; 5.SNQ; 6.LNQ)
...
f.close()
print('=========================Finish one dispatching testing=========================================')